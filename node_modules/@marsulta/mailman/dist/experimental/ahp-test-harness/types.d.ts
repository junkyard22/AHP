export type AHPTestEventType = "TASK_ACCEPTED" | "TASK_PROGRESS" | "TASK_PARTIAL_OUTPUT" | "TASK_COMPLETED" | "TASK_FAILED" | "TASK_CANCELLED" | "AGENT_ONLINE" | "AGENT_OFFLINE";
export type AHPEnvelopeKind = "session.connect" | "session.connected" | "task.send" | "task.accept" | "task.progress" | "task.partial_output" | "task.completed" | "task.failed" | "task.cancel" | "task.cancelled" | "agent.online" | "agent.offline";
export type AHPTestDirection = "maestro->workbench" | "workbench->ahp" | "ahp->workbench" | "workbench->maestro";
...
export type AHPTestAgentHandler = (envelope: AHPEnvelope, context: AHPTestAgentContext) => Promise<void> | void;
