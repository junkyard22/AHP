...
export type BuiltinPacketType = "task.assign" | "task.accept" | "task.reject" | "task.result" | "task.ack" | "task.nack" | "review.request" | "review.result" | "route.request" | "route.result" | "error.report" | "health.ping" | "health.pong" | "stream.open" | "stream.chunk" | "stream.close" | "stream.error";
/**
...
export type PacketStatus = "created" | "validated" | "delivered" | "accepted" | "rejected" | "completed" | "failed" | "timed_out";
 ...
 */
export type StreamHandler = (packet: MailmanPacket, stream: StreamController) => Promise<void>;
...
export type MailmanTraceEvent = "packet.received" | "packet.validated" | "packet.rejected" | "packet.routed" | "packet.delivered" | "packet.completed" | "packet.failed" | "packet.dispatched" | "packet.published" | "handler.started" | "handler.finished" | "handler.threw" | "stream.opened" | "stream.chunk" | "stream.closed" | "stream.errored" | "packet.scheduled" | "packet.acked" | "packet.nacked";
...
export declare const BUILTIN_PACKET_TYPES: BuiltinPacketType[];
/** @deprecated Use BUILTIN_PACKET_TYPES. Will be removed in v1. */
export declare const ALL_PACKET_TYPES: PacketType[];
